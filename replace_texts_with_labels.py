...
def replace_in_file(source_file_path, csv_file_path, output_file_path):
    ...
    # Replace the text with the labels
...
# Script options
source_code_path = 'project.gbsproj'     # Change this to the path of your GB Studio project file (.gbsproj)
csv_path = 'translation_labels.csv'      # Change this to the path of your CSV file
output_path = 'project.gbsproj.labeled'  # Output file path
